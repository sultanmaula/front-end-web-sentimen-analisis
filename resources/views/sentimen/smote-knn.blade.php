...
@section('content_header')
    <h1 class="m-0 text-dark">SMOTE + KNN</h1>
@stop
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        @if (count($datas) > 0)
                        <a href="{{ route('reset-smote-knn') }}" class="btn btn-sm btn-danger"><span class="fa fa-retweet"></span> Reset</a>
                        @else
                        <a href="{{ route('smote-knn-start') }}" class="btn btn-sm btn-secondary" type="submit"><span class="fa fa-arrow-right"></span> Start SMOTE + KNN</a>
                        @endif
                    </div>
                    <div class="mt-4">
                        <h5>Precision</h5>
